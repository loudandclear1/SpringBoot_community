...
import com.hgz.community.dao.elasticsearch.DiscussPostRepository;
...
public class ElasticsearchTests {
    ...
    public void testUpdate() {
        ...
        post.setContent("这是通过Elasticsearch修改的数据！");
    ...
    public void testSearchByRepository() {
        ...
        System.out.println(page.getNumber()); // 当前处在多少页
        System.out.println(page.getSize()); // 当前一页显示多少条数据
